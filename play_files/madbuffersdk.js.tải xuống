 ...
 * @Last Modified time: 2021-09-20 23:26:13
 */
setTimeout(function() {
    Init();
    // Mute(false);
...
function Init() {
    ...
    if (platform === "h5") {
        ...
        if (href.indexOf("gamedistribution.com") >= 0) {
            ...
            InitGameDistribution("189ed209ac764042b8db5eaad432bcd9");
...
function InitGameMonetize(gameKey) {
    ...
    (function(a, b, c) {
        ...
        a.getElementById(c) || (a = a.createElement(b), a.id = c, a.src = "./sdk.js", d.parentNode.insertBefore(a, d))
...
function ShowAdsImage() {
    ...
    if (platform == "h5") {
        op.style = "position: fixed; float:right;width: 72px;height: 72px;background-color: transparent;margin-top:10px;left: 30px;bottom:80px;z-index: 9";
    } else {
        op.style = "position: fixed; float:right;width: 60px;height: 60px;background-color: transparent;margin-top:10px;right: 20px;top:20px;z-index: 9";
    }
