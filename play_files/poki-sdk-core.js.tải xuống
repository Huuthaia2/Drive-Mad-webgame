! function(t) {
    ...
    t.exports = function(t, n, e, u, m, w, y) {
        ...
        if (I && (v = o(I.call(new t)), f !== Object.prototype && v.next && (A || o(v) === f || (a ? a(v, f) : "function" != typeof v[g] && d(v, g, h)), s(v, E, !0, !0), A && (l[E] = h))), "values" == m && z && "values" !== z.name && (x = !0, C = function() {
                return z.call(this)
            }), A && !y || T[g] === C || d(T, g, C), l[n] = C, m)
            if (k = {
                    values: S("values"),
                    keys: w ? C : S("keys"),
                    entries: S("entries")
    ...
    f && p || (f = function(t) {
        ...
        w.now(b(t))
    } : h && !l ? (o = (r = new h).port2, r.port1.onmessage = S, i = c(o.postMessage, o, 1)) : !a.addEventListener || "function" != typeof postMessage || a.importScripts || s(E) || "file:" === m.protocol ? i = "onreadystatechange" in A("script") ? function(t) {
    ...
    var i, r, o, a, s = e(5),
                ...
                x((function() {
                    for (var r = n.value, o = 1 == n.state, a = 0; i.length > a;) {
                        var s, d, c, u = i[a++],
                            ...
                            f = u.domain;
                        try {
                            A ? (o || (2 === n.rejection && nt(t, n), n.rejection = 1), !0 === A ? s = r : (f && f.enter(), s = A(r), f && (f.exit(), c = !0)), s === u.promise ? m(G("Promise-chain cycle")) : (d = K(s)) ? d.call(s, l, m) : l(s)) : m(r)
                        } catch (t) {
                            f && !c && f.exit(), m(t)
                        }
                    }
        ...
        $ = function(t, n) {
            E.call(c, (function() {
                ...
                if (tt(n) && (e = I((function() {
                        H ? X.emit("unhandledRejection", i, t) : Y("unhandledrejection", t, i)
        ...
        nt = function(t, n) {
            E.call(c, (function() {
                H ? X.emit("rejectionHandled", t) : Y("rejectionhandled", t, n.value)
            }))
        },
        et = function(t, n, e, i) {
            return function(r) {
    ...
    V && (Z = function(t) {
        ...
        then: function(t, n) {
            var e = M(this),
                i = Q(S(this, Z));
            return i.ok = "function" != typeof t || t, i.fail = "function" == typeof n && n, i.domain = H ? X.domain : void 0, e.parent = !0, e.reactions.push(i), 0 != e.state && J(this, e, !1), i.promise
        },
        catch: function(t) {
    ...
    ! function(t) {
        ...
        if (!t.fetch) {
            ...
            }, t.Headers = f, t.Request = v, t.Response = b, t.fetch = function(t, n) {
    ...
    var s, d, c, u = e(11),
        ...
        g = function() {
            ...
            return t.sendMessage = function(t, n) {
                ...
                var e = window.parent;
                if (!p(t, l.message)) {
                    var i = Object.keys(l.message).map((function(t) {
        ...
        y = function() {
            ...
            return t.setDebug = function(t) {
                ...
                g.sendMessage(l.message.event, {
                    event: t,
                    data: n
                })
            }, t.setupDefaultEvents = function() {
                var n, e = ((n = {})[l.ready] = l.tracking.sdk.status.initialized, n[l.adblocked] = l.tracking.sdk.status.failed, n[l.ads.busy] = l.tracking.ads.status.busy, n[l.ads.completed] = l.tracking.ads.status.completed, n[l.ads.error] = l.tracking.ads.status.error, n[l.ads.displayError] = l.tracking.ads.status.displayError, n[l.ads.impression] = l.tracking.ads.status.impression, n[l.ads.limit] = l.tracking.ads.status.limit, n[l.ads.ready] = l.tracking.ads.status.ready, n[l.ads.requested] = l.tracking.ads.status.requested, n[l.ads.prebidRequested] = l.tracking.ads.status.prebidRequested, n[l.ads.skipped] = l.tracking.ads.status.skipped, n[l.ads.started] = l.tracking.ads.status.started, n[l.ads.video.clicked] = l.tracking.ads.video.clicked, n[l.ads.video.error] = l.tracking.ads.video.error, n[l.ads.video.loaderError] = l.tracking.ads.video.loaderError, n[l.ads.video.buffering] = l.tracking.ads.status.buffering, n[l.tracking.screen.gameplayStart] = l.tracking.screen.gameplayStart, n[l.tracking.screen.gameplayStop] = l.tracking.screen.gameplayStop, n[l.tracking.screen.loadingProgress] = l.tracking.screen.loadingProgress, n[l.tracking.screen.commercialBreak] = l.tracking.screen.commercialBreak, n[l.tracking.screen.rewardedBreak] = l.tracking.screen.rewardedBreak, n[l.tracking.screen.happyTime] = l.tracking.screen.happyTime, n[l.tracking.screen.sendHighscore] = l.tracking.screen.sendHighscore, n[l.tracking.screen.getLeaderboard] = l.tracking.screen.getLeaderboard, n);
        ...
        b = function() {
            function t(t) {
                ...
                }, f.addEventListener(l.ads.requested, this.startTimeBetweenAdsTimer.bind(this)), f.addEventListener(l.ads.completed, this.startTimeBetweenAdsTimer.bind(this)), f.addEventListener(l.ads.stopped, this.startTimeBetweenAdsTimer.bind(this))
            }
            ...
            ! function() {
                if (!window.__tcfapi) {
                    ...
                    window.__tcfapi = function(n, e, i, r) {
                        if (!bt.GetIsPokiIFrame() && !_()) return i({
                            msg: "CMP not found"
    ...
    var G = function() {
            function t(t, n) {
                void 0 === n && (n = {}), this.retries = 0, this.running = !1, this.ima = t, this.siteID = n.siteID || 3, 0 === n.siteID && (n.siteID = 3), this.totalRetries = n.totalRetries || v.waterfallRetries || 1, this.timing = n.timing || new b(v.adTiming), this.overwriteAdTagUrls = n.adTagUrl ? k(n.adTagUrl) : [], f.addEventListener(l.ads.video.error, this.moveThroughWaterfall.bind(this)), f.addEventListener(l.ads.video.loaderError, this.moveThroughWaterfall.bind(this)), f.addEventListener(l.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)), f.addEventListener(l.ads.started, this.stopWaterfall.bind(this))
            }
            return t.prototype.moveThroughWaterfall = function() {
                if (!1 !== this.running) {
                    ...
                    this.running = !1, this.timing.resetWaterfallTimerIdx(), f.dispatchEvent(l.ads.error, {
                        message: "No ads"
                    })
                }
                ...
                if (this.debug) {
                    ...
                    return t === l.ads.position.rewarded ? [e + "debug-video-rewarded" + n] : t === l.ads.position.preroll ? [e + "debug-video-preroll" + n] : [e + "debug-video-midroll" + n]
                }
                if (this.overwriteAdTagUrls.length > 0 && bt.GetIsPokiPlatform()) return this.overwriteAdTagUrls;
                var i = "desktop",
                    r = "midroll";
                E() ? i = "mobile" : x() && (i = "tablet"), t === l.ads.position.rewarded && (r = "rewarded");
                ...
                void 0 === t && (t = {}), this.running = !0, this.retries = 0, this.criteria = t, this.timing.resetWaterfallTimerIdx(), this.rewarded = n === l.ads.position.rewarded, this.adTagUrls = this.buildAdTagUrls(n), this.requestAd()
                ...
                bt.childDirected && (r += "&tfcd=1"), bt.nonPersonalized && (r += "&npa=1"), f.setDataAnnotations({
                    adTagUrl: r,
                    waterfall: this.retries
                }), f.dispatchEvent(l.ads.requested), 1 !== this.retries || E() || x() ? (console.debug("adRequest started in plain mode"), this.ima.requestAd(r)) : (console.debug("adRequest started with Prebid Video enabled"), function(t, n, e, i) {
                    if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
                        var r, o = S().split("?"),
                            ...
                            c = function() {
                                if (!(--d > 0)) try {
                                    f.dispatchEvent(l.ads.prebidRequested);
                        ...
                        R && (d++), window.pbjs.que.push((function() {
        ...
        F = "pokiSdkPauseButton",
        X = "pokiSdkProgressBar",
        N = "pokiSdkSpinnerContainer",
        Q = "pokiSdkVisible",
        U = function() {
            function t(t) {
                // var n = this;
                ...
                //     }, this.wrapper = t.wrapper, f.addEventListener(l.ads.video.progress, (function(t) {
    ...
    var $ = function(t, n, e, i) {
        ...
        nt = function() {
            ...
            return t.prototype.initAdDisplayContainer = function() {
                ...
                f.dispatchEvent(l.ads.stopped), this.tearDown()
            }, t.prototype.resumeAd = function() {
                f.dispatchEvent(l.ads.video.resumed), this.adsManager && this.adsManager.resume()
                ...
                f.dispatchEvent(l.ads.video.loaderError, {
                    message: n
                })
            }, t.prototype.onAdError = function(t) {
                this.tearDown();
                var n = t.getError && t.getError().toString() || "Unknown";
                f.dispatchEvent(l.ads.video.error, {
                    message: n
                })
    ...
    var ot = function() {
        return
            ...
            return fetch("./@sdk?href=" + n + "&referrer=" + e, {
                method: "GET",
                headers: {
                            ...
                            switch (m.label) {
                                ...
                                case 2:
                                    if (e = r.apply(i, [(o.d = [(a.v = d.apply(s, [(c.json = u, c.body = JSON.stringify({
                                        ...
                                        }), c.name = t.name, c.message = t.message, c)]), a)], o)]), A = "", navigator.sendBeacon) navigator.sendBeacon(A, e);
                                    else try {
    ...
    function dt() {
        return at(this, void 0, Promise, (function() {
            ...
            return st(this, (function(n) {
                switch (n.label) {
                    case 0:
                        return n.trys.push([0, 3, , 4]), [4, fetch("https://geo.poki.io/", {
                            method: "GET",
                            headers: {
                                "Content-Type": "text/plain"
                            }
                ...
                return At(this, (function(i) {
                    switch (i.label) {
                        ...
                        case 3:
                            ...
                            }, document.head.appendChild(n), lt = !0), [3, 5];
                        case 4:
        ...
        bt = function() {
            ...
            return t.prototype.init = function(t) {
                ...
                var n, e = this,
                    ...
                    A = i.prebid,
                    m = void 0 === A ? {} : A,
                    p = i.waterfallRetries,
                    g = i.wrapper,
                    h = void 0 === g ? document.body : g,
                    w = parseInt(T("site_id"), 10) || 0;
                    n = m, window.pbjs = window.pbjs || {}, window.pbjs.que = window.pbjs.que || [], window.pbjs.que.push((function() {
                ...
                var k = vt({}, v);
                r ? (t.isPokiPlatform = !0, k = vt(vt({}, k), {
                    adTagUrl: r,
                    customCriteria: d,
                    adTiming: a
                })) : t.isPokiPlatform = !1;
                var b = ot;
                (t.isPokiPlatform || this.debug) && (b = function() {
                    return Promise.resolve()
                });
                var S = dt,
                    z = this.initOptions.country || T("country");
                return z && (S = function() {
                    return Promise.resolve(z)
                }), window.addEventListener("resize", this.resize.bind(this), !1), window.addEventListener("message", this.onMessage.bind(this), !1), this.debugIsOverwritten || this.setDebug(this.debug || u), this.debugTouchOverlayController && (E() || x()) && mt(), Promise.all([b(), S()]).catch((function() {
                    f.dispatchEvent(l.adblocked)
                })).then((function(n) {
                    if (void 0 !== n) {
                        var i = n[0],
                            r = n[1],
                        ...
                        if (i) {
                            ...
                            ["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(kt.gameId) && (E() || x()) && mt(), o.adTiming = i.adTiming, o.customCriteria = vt(vt({}, o.customCriteria), {
                                p4d_game_id: kt.gameId
                            })
                        }
                        e.debug && (o.adTiming.startAdsAfter = 0), e.enableSettings(o);
                        var a = J(e.country);
                        a && (t.GetIsPokiPlatform() || t.GetIsPokiIFrame()) && M(), e.playerSkin = new U({
                                wrapper: h
                            }), e.ima = new nt, e.playerSkin.setupEvents(e), e.startStartAdsAfterTimerOnInit && e.adTimings.startStartAdsAfterTimer(), e.waterfall = new G(e.ima, {
                                timing: e.adTimings,
                                totalRetries: p,
                                adTagUrl: o.adTagUrl,
                                siteID: w
                            ...
                            function(t) {
                                // window.apstag && window.apstag.init(B({
                                ...
                                //     R = !0
                                // }))
                            }(a), e.isInitialized = !0, f.dispatchEvent(l.ready)
                    }
                }))
                ...
                var i = function() {
                    var i = n.autoStart,
                        ...
                        A = n.position,
                        m = void 0 === A ? null : A;
                    if (e.autoStartOnReady = !1 !== r, d && e.registerHandler("onFinish", d), u && e.registerHandler("onStart", u), !e.sdkBooted) return f.dispatchEvent(l.ads.error, {
                        message: "Requesting ad on unbooted SDK"
                    }), void e.sdkNotBootedButCalled();
                    if (e.sdkImaError) f.dispatchEvent(l.ads.error, {
                        message: "Adblocker has been detected"
                    });
                    else if (!E() && !x() || m === l.ads.position.rewarded)
                        if (null !== m && p(m, l.ads.position))
                            if (e.ima.isAdRunning() || e.waterfall.isRunning()) f.dispatchEvent(l.ads.busy);
                            else if (e.adReady) f.dispatchEvent(l.ads.ready);
                    else if (m !== l.ads.position.preroll || e.adTimings.prerollPossible())
                        if (m === l.ads.position.rewarded || e.adTimings.requestPossible()) {
                            var g = vt(vt(vt({}, e.genericCriteria()), e.criteria), {
                                position: m
                            });
                            (t.isPokiPlatform || m === l.ads.position.rewarded) && (g = vt(vt({}, g), a)), e.playerSkin.showWithOpacity(), e.resize(), e.waterfall.start(g, m)
                        } else f.dispatchEvent(l.ads.limit, {
                            reason: l.info.messages.timeLimit
                        });
                    else f.dispatchEvent(l.ads.limit, {
                        reason: l.info.messages.prerollLimit
                    });
                    else console.error("POKI-SDK: Invalid position");
                    else f.dispatchEvent(l.ads.error, {
                ...
                var e = this,
                    i = function() {
                        f.clearAnnotations();
                        var i = ft(),
                            r = l.ads.position.display;
                        if (n) {
                            if (!e.sdkBooted) return f.dispatchEvent(l.ads.error, {
                                message: "Requesting ad on unbooted SDK",
                                position: r
                            }), void e.sdkNotBootedButCalled();
                            if (t)
                                if (e.sdkImaError) f.dispatchEvent(l.ads.error, {
                                    ...
                                    if (! function(t) {
                                            return !!(E() || x() || ["970x250", "300x250", "728x90", "160x600"].includes(t)) && !((E() || x()) && !["320x50"].includes(t))
                                        }(n)) return f.dispatchEvent(l.ads.error, {
                ...
                var n = this,
                    e = function() {
                        if (!n.sdkBooted) return f.dispatchEvent(l.ads.displayError, {
                            message: "Attempting destroyAd on unbooted SDK"
                        }), void n.sdkNotBootedButCalled();
                        n.sdkImaError ? f.dispatchEvent(l.ads.displayError, {
                            message: "Adblocker has been detected"
                ...
                this.criteria = vt({}, t.customCriteria), this.adTimings = new b(t.adTiming), this.country = t.country
                ...
                var n = this;
                this.debugIsOverwritten ? t && y.track(l.tracking.debugTrueInProduction) : (y.setDebug(t), f.setDebug(t), this.waterfall ? this.waterfall.setDebug(t) : f.addEventListener(l.ready, (function() {
                ...
                if (!this.sdkBooted) return this.sdkNotBootedButCalled();
                this.sdkImaError || (this.adReady ? (this.playerSkin.show(), this.resize(), this.ima.startPlayback()) : f.dispatchEvent(l.ads.error, {
                ...
                var t = this;
                f.addEventListener(l.ready, (function() {
                    t.sdkBooted = !0, t.callHandler("onReady")
                })), f.addEventListener(l.adblocked, (function() {
                    t.sdkBooted = !0, t.sdkImaError = !0, t.callHandler("onAdblocked")
                })), f.addEventListener(l.ads.ready, (function() {
                    t.adReady = !0, t.autoStartOnReady && t.startAd()
                })), f.addEventListener(l.ads.started, (function() {
                    t.playerSkin.hideSpinner(), t.callHandler("onStart", {
                        type: l.ads.limit
                    })
                })), f.addEventListener(l.ads.video.paused, (function() {
                    t.playerSkin.showPauseButton()
                })), f.addEventListener(l.ads.limit, (function() {
                    t.callHandler("onFinish", {
                        type: l.ads.limit,
                        rewardAllowed: !1
                    })
                })), f.addEventListener(l.ads.stopped, (function() {
                    t.callHandler("onFinish", {
                        type: l.ads.stopped,
                        rewardAllowed: !1
                    })
                })), f.addEventListener(l.ads.error, (function() {
                    t.callHandler("onFinish", {
                        type: l.ads.error,
                        rewardAllowed: !1
                    })
                })), f.addEventListener(l.ads.busy, (function() {
                    t.callHandler("onFinish", {
                        type: l.ads.busy,
                        rewardAllowed: !1
                    })
                })), f.addEventListener(l.ads.completed, (function(n) {
                    t.callHandler("onFinish", {
                        type: l.ads.completed,
                        rewardAllowed: !!n.rewardAllowed
                    })
                })), [l.ads.limit, l.ads.stopped, l.ads.error, l.ads.busy, l.ads.completed].forEach((function(n) {
                ...
                var t = {},
                    ...
                    i = encodeURIComponent(T("categories") || "");
                return t.tag = n, t.tag_site = n + "|" + e, t.site_id = e, t.categories = i, this.programmaticAdsEnabled || (t.disable_programmatic = 1), t
    ...
    if ("undefined" != typeof window) {
        A.a.remoteFetching = !1, A.a.report.subscribe((function(t) {
            if ("Script error." === t.message && window.pokiLastCatch) {
                var n = window.pokiLastCatch;
                window.pokiLastCatch = null, A.a.report(n)
            } else Ct(t)
        })), window.onunhandledrejection = function(t) {
            St(t.reason) ? A.a.report(t.reason) : Ct({
    ...
    var Lt = function() {
        ...
        Ot = new(function() {
            function t() {
                var t = this;
                this.gameStarted = !1, this.SDK = new bt, this.gameplayStartCounter = 0, this.gameplayStopCounter = 0, this.init = function(n) {
                    return void 0 === n && (n = {}), new Promise((function(e, i) {
                        n && n.adTagUrl && window && (window.__InternalSDK = t.SDK), t.SDK.init(Lt({
                            onReady: e,
                            onAdblocked: i
                        }, n)), g.sendMessage(l.message.sdkDetails, {
                            version: "2.137.0"
                        })
                    }))
                    ...
                    y.track(l.tracking.screen.gameLoadingStarted)
                }, this.gameLoadingFinished = function() {
                    y.track(l.tracking.screen.gameLoadingFinished)
                }, this.gameplayStart = function(n) {
                    t.gameplayStartCounter++, t.gameStarted || (t.gameStarted = !0, y.track(l.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()), y.track(l.tracking.screen.gameplayStart, Lt(Lt({}, n), {
                        playId: t.gameplayStartCounter
                    }))
                }, this.gameInteractive = function() {
                    y.track(l.tracking.screen.gameInteractive)
                }, this.gameplayStop = function(n) {
                    t.gameplayStopCounter++, y.track(l.tracking.screen.gameplayStop, Lt(Lt({}, n), {
                        playId: t.gameplayStartCounter,
                        stopId: t.gameplayStopCounter
                    }))
                }, this.roundStart = function(t) {
                    void 0 === t && (t = ""), t = String(t), y.track(l.tracking.screen.roundStart, {
                        identifier: t
                    })
                }, this.roundEnd = function(t) {
                    void 0 === t && (t = ""), t = String(t), y.track(l.tracking.screen.roundEnd, {
                        identifier: t
                    })
                }, this.customEvent = function(n, e, i) {
                    void 0 === i && (i = {}), n && e ? (n = String(n), e = String(e), i = Lt({}, i), y.track(l.tracking.custom, {
                        eventNoun: n,
                        eventVerb: e,
                        eventData: i
                    ...
                    return new Promise((function(n) {
                        n()
                        // var e = t.gameStarted ? l.ads.position.midroll : l.ads.position.preroll;
                        // f.clearAnnotations(), f.setDataAnnotations({
                        //     opportunityId: ft(),
                        //     position: e
                        // }), y.track(l.tracking.screen.commercialBreak), t.SDK.requestAd({
                        //     position: e,
                        //     onFinish: n
                        // })
                    }))
                    ...
                    return new Promise((function(n) {
                        ...
                        return
                        var e = l.ads.position.rewarded;
                        f.clearAnnotations(), f.setDataAnnotations({
                            opportunityId: ft(),
                            position: e
                        }), y.track(l.tracking.screen.rewardedBreak), t.SDK.requestAd({
                            position: e,
                            onFinish: function(t) {
                    ...
                    void 0 === n && (n = 1), ((n = Number(n)) < 0 || n > 1) && (n = Math.max(0, Math.min(1, n)), t.warning("happyTime", "Intensity should be a value between 0 and 1, adjusted to " + n)), y.track(l.tracking.screen.happyTime, {
                        intensity: n
                    })
                }, this.muteAd = function() {
                    t.SDK.muteAd()
                }, this.setPlayerAge = function(n) {
                    y.track(l.tracking.setPlayerAge, {
                        age: n
                    }), n && t.SDK.setPlayerAge(n)
                }, this.togglePlayerAdvertisingConsent = function(n) {
                    y.track(l.tracking.togglePlayerAdvertisingConsent, {
                        didConsent: n
                    }), t.SDK.togglePlayerAdvertisingConsent(n), g.sendMessage(l.message.toggleProgrammaticAds, {
                    ...
                    y.track(l.tracking.screen.sendHighscore, {
                        score: t
                    })
                }, this.setDebugTouchOverlayController = function(n) {
                    t.SDK.debugTouchOverlayController = n
                }, this.getLeaderboard = function() {
                    if (y.track(l.tracking.screen.getLeaderboard, {}), t.SDK.debug) {
            ...
            return t.prototype.setDebug = function(t) {
                ...
                y.track(l.tracking.screen.displayAd, {
                    size: n
                }), this.SDK.displayAd(t, n)
            }, t.prototype.destroyAd = function(t) {
                y.track(l.tracking.screen.destroyAd), this.SDK.destroyAd(t)
            }, t
        }());
